function cuentaRegresiva() {
    ...
    const intervalo = setInterval(() => {
      ...
      document.getElementById("contador").innerHTML = '<h5 class="text-white">' + tiempoFormateado + '</h5>';
      ...
      if (tiempoRestante < 0) {
        ...
        document.getElementById("contador").innerHTML = '<h5 class="text-white">¡Tiempo terminado!</h5>';
      }
